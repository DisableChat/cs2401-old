/*******************************************************************************
	...
	CS2401 Proj 3
	10-10-17
	Description: This is collegemain.cc which Proffesor Dolan has provided us
				with. More info regarding this file can be in the next comment
				box.
*******************************************************************************/
...
int main(){
	...
	while(choice != 0){
		...
		cout<<"This would make your GPA: "<<acopy.gpa();
   		cout<<" And your courselist would look like." << endl;
		acopy.display(cout);
