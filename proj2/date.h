...
9-21-17
Proj 2
Description: This is class date which we use in our program. This 
was provided by professor Dolan. We use the date class to prooperly 
implement dates in our friend class. Further info can be found in the 
text box below.
*********************************************************************/
