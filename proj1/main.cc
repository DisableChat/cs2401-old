...
CS2401 Proj 1
Sep-11-2017
Description: This is the main for the Checkbook proj, this main
was provided by Dolan. The main has a menu which allows users to
manipulate a checkbook, while also backing up their info if they 
exit the program so they can continue to use it later on if 
...
be using it to test your program.
  	John Dolan		Ohio University EECS	September 2017
**********************************************************************/
#include <iostream>
#include <fstream>
#include <string>
